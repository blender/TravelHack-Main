...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [rideArray addObject:[Ride rideWithDictionary:[rideDictionary objectForKey:[NSString stringWithFormat:@"%d", [indexPath row]]]]];
    
    cell.textLabel.text = [[rideArray objectAtIndex:[indexPath row]] rideName];
